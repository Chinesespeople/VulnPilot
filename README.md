...
```text
4f4300d88a384f6fd958fd12eb1c51a0fc57f83a8494bcfc4ef728fa60402b27
```
...
- 当前支持 Claude、Codex、Mimo、Qwen 和 Kimi，本机存在对应命令时才会显示。
- 默认使用 Claude。
...
- [Kimi Code CLI 接入 DeepSeek](docs/agents/kimi-deepseek.md)
...
VulnPilot 仅用于获得明确授权的安全测试和教学环境。涉及文件上传、命令执行、数据修改等风险操作时，应根据测试范围配置授权规则并核对智能体实际操作。
